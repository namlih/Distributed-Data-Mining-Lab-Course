...
sequences = sc.textFile("hdfs:///dataset2.txt")
...
sc.parallelize([('ROC_training', metrics_tr.areaUnderROC), ('PR_training', metrics_tr.areaUnderPR),('ROC_test', metrics.areaUnderROC), ('PR_test', metrics.areaUnderPR)]).saveAsTextFile("hdfs:///random_forest_metrics_16.txt")
