...
def train_pred(param):
    model = GradientBoostedTrees.trainClassifier(data=trainData, categoricalFeaturesInfo={}, numIterations=param)
...
result = train_pred(param)
sc.parallelize(result).saveAsTextFile("hdfs:///"+output)
